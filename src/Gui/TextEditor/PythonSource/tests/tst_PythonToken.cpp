...
public:
    ...
    void fillLine0() {
        _line[0]->push_front(new Token(Token::T_IdentifierClass, 6, 10, nullptr));
        _line[0]->push_front(new Token(Token::T_KeywordClass, 0, 4, nullptr));
        _line[0]->push_back(new Token(Token::T_DelimiterOpenParen, 11, 12, nullptr));
        _line[0]->push_back(new Token(Token::T_DelimiterCloseParen, 12, 13, nullptr));
        _line[0]->push_back(new Token(Token::T_DelimiterColon, 13, 14, nullptr));
        _line[0]->push_back(new Token(Token::T_DelimiterNewLine, 14, 15, nullptr));
    }
    void fillLine1() {
        //_line[1]->setIndentCount(4);
        _line[1]->push_front(new Token(Token::T_IdentifierMethod, 7, 23, nullptr));
        _line[1]->push_front(new Token(Token::T_KeywordDef, 4, 6, nullptr));
        _line[1]->insert(new Token(Token::T_Indent, 0, 3, _line[1]));
        _line[1]->insert(_line[1]->back(), new Token(Token::T_DelimiterOpenParen, 23, 24, nullptr));
        _line[1]->push_back(new Token(Token::T_IdentifierDefined, 24, 27, nullptr));
        _line[1]->push_back(new Token(Token::T_DelimiterCloseParen, 28, 29, nullptr));
        _line[1]->push_back(new Token(Token::T_DelimiterColon, 29, 30, nullptr));
        _line[1]->push_back(new Token(Token::T_DelimiterNewLine, 30, 30, nullptr));
    }
    void fillLine2() {
        _line[2]->push_back(new Token(Token::T_Indent, 0, 7, nullptr));
        _line[2]->push_back(new Token(Token::T_LiteralBlockDblQuote, 8, 73, nullptr));
        _line[2]->push_back(new Token(Token::T_DelimiterNewLine, 73, 73, nullptr));
    }
    void fillLine3() {
        _line[3]->push_back(new Token(Token::T_KeywordDef, 8, 11, nullptr));
        _line[3]->push_back(new Token(Token::T_DelimiterColon, 11,12, nullptr));
        _line[3]->push_back(new Token(Token::T_DelimiterNewLine, 12, 12, nullptr));
    }
    void fillLine4() {
        _line[4]->push_back(new Token(Token::T_KeywordFrom, 12, 16, nullptr));
        _line[4]->push_front(new Token(Token::T_Indent, 0, 11, _line[4]));
        _line[4]->push_back(new Token(Token::T_IdentifierModulePackage, 17, 21, nullptr));
        _line[4]->push_back(new Token(Token::T_IdentifierModulePackage, 17, 21, nullptr));
        _line[4]->push_back(new Token(Token::T_DelimiterNewLine, 21, 21, nullptr));
    }
    void fillLine5() {
        _line[5]->push_back(new Token(Token::T_IdentifierDefined, 12, 17, nullptr));
        _line[5]->push_back(new Token(Token::T_OperatorEqual, 19, 20, nullptr));
        _line[5]->push_back(new Token(Token::T_IdentifierUnknown, 21, 25, nullptr));
        _line[5]->push_back(new Token(Token::T_DelimiterPeriod, 25, 26, nullptr));
        _line[5]->push_back(new Token(Token::T_IdentifierUnknown, 26, 43, nullptr));
        _line[5]->push_back(new Token(Token::T_OperatorMoreEqual, 44, 46, nullptr));
        _line[5]->push_back(new Token(Token::T_NumberDecimal, 47, 48, nullptr));
        _line[5]->push_back(new Token(Token::T_DelimiterNewLine, 48, 48, nullptr));
        _line[5]->push_back(new Token(Token::T_Dedent, 48, 48, nullptr));
    }
    void fillLine6() {
        _line[6]->push_back(new Token(Token::T_KeywordExcept, 8, 13, _line[6]));
        _line[6]->push_back(new Token(Token::T_DelimiterOpenParen, 14, 15, _line[6]));
        _line[6]->push_back(new Token(Token::T_IdentifierBuiltin, 15, 27, _line[6]));
        _line[6]->push_back(new Token(Token::T_DelimiterComma, 28, 29, _line[6]));
        _line[6]->push_back(new Token(Token::T_IdentifierBuiltin, 30, 42, _line[6]));
        _line[6]->push_back(new Token(Token::T_DelimiterCloseParen, 42, 43, _line[6]));
        _line[6]->push_back(new Token(Token::T_DelimiterColon, 43, 44, _line[6]));
        _line[6]->push_back(new Token(Token::T_DelimiterNewLine, 44, 44, _line[6]));
    }
    void fillLine7() {
        _line[7]->push_back(new Token(Token::T_Indent, 0, 11, nullptr));
        _line[7]->push_back(new Token(Token::T_IdentifierUnknown, 11, 14, nullptr));
        _line[7]->push_back(new Token(Token::T_OperatorEqual, 15, 16, nullptr));
        _line[7]->push_back(new Token(Token::T_IdentifierFalse, 17, 22, nullptr));
        _line[7]->push_back(new Token(Token::T_DelimiterNewLine, 22, 22, nullptr));
        _line[7]->push_back(new Token(Token::T_Dedent, 22, 22, nullptr));
    }
    void fillLine8() {
        _line[8]->push_back(new Token(Token::T_KeywordIf, 7, 9, nullptr));
        _line[8]->push_back(new Token(Token::T_IdentifierDefined, 10, 15, nullptr));
        _line[8]->push_back(new Token(Token::T_DelimiterColon, 15, 16, nullptr));
        _line[8]->push_back(new Token(Token::T_DelimiterNewLine, 16, 16, nullptr));
    }
    void fillLine9() {
        _line[9]->push_back(new Token(Token::T_Indent, 0, 12, nullptr));
        _line[9]->push_back(new Token(Token::T_KeywordReturn, 12, 18, nullptr));
        _line[9]->push_back(new Token(Token::T_IdentifierDefined, 19, 23, nullptr));
        _line[9]->push_back(new Token(Token::T_DelimiterPeriod, 23, 24, nullptr));
        _line[9]->push_back(new Token(Token::T_IdentifierDefined, 24, 30, nullptr));
        _line[9]->push_back(new Token(Token::T_DelimiterOpenParen, 30, 31, nullptr));
        _line[9]->push_back(new Token(Token::T_LiteralSglQuote, 31, 38, nullptr));
        _line[9]->push_back(new Token(Token::T_DelimiterCloseParen, 38, 39, nullptr));
        _line[9]->push_back(new Token(Token::T_DelimiterNewLine, 39, 39, nullptr));
        _line[9]->push_back(new Token(Token::T_Dedent, 39, 39, nullptr));
    }
    void fillLine10() {
        _line[10]->push_back(new Token(Token::T_KeywordElse, 7, 11, nullptr));
        _line[10]->push_back(new Token(Token::T_DelimiterColon, 11, 12, nullptr));
        _line[10]->push_back(new Token(Token::T_DelimiterNewLine, 12, 12, nullptr));
    }
    void fillLine11() {
        _line[11]->push_back(new Token(Token::T_Comment, 11, 22, nullptr));
    }
    void fillLine12() {
        _line[12]->push_back(new Token(Token::T_Indent, 0, 11, nullptr));
        _line[12]->push_back(new Token(Token::T_KeywordReturn, 11, 17, nullptr));
        _line[12]->push_back(new Token(Token::T_IdentifierDefined, 18, 22, nullptr));
        _line[12]->push_back(new Token(Token::T_DelimiterPeriod, 22, 23, nullptr));
        _line[12]->push_back(new Token(Token::T_IdentifierDefined, 23, 29, nullptr));
        _line[12]->push_back(new Token(Token::T_DelimiterOpenParen, 29, 30, nullptr));
        _line[12]->push_back(new Token(Token::T_LiteralSglQuote, 30, 38, nullptr));
        _line[12]->push_back(new Token(Token::T_DelimiterCloseParen, 38, 39, nullptr));
        _line[12]->push_back(new Token(Token::T_DelimiterNewLine, 39, 39, nullptr));
        _line[12]->push_back(new Token(Token::T_Dedent, 39, 39, nullptr));
    }
};
...
TEST_F(TstPythonToken, testPythonTokenTypeTest) {
    Token inValidTok(Token::T_Invalid, 0, 0, nullptr);
