 ...
 */
void PythonConsoleTextEdit::keyPressEvent(QKeyEvent* e)
{
 ...
 */
void PythonConsoleTextEdit::highlightText(int pos, int len, const QTextCharFormat format)
{
 ...
 * Completes the word.
 */
void PythonConsoleTextEdit::complete()
{
 ...
 */
void PythonConsoleTextEdit::createListBox()
{
        ...
        switch (e->key())
        {
          ...
          default:
              if (e->text().isEmpty() ||
                  ...
                  PythonConsoleTextEdit::keyPressEvent(e);
              }
...
{
    PythonConsoleTextEdit::showEvent(e);
...
void PythonConsole::changeEvent(QEvent *e)
{
    ...
    PythonConsoleTextEdit::changeEvent(e);
}

void PythonConsole::mouseReleaseEvent( QMouseEvent *e )
{
  PythonConsoleTextEdit::mouseReleaseEvent( e );
    ...
    case ErrorOutput:
        {
            ...
            errorFormat.setForeground(colorByType(SyntaxHighlighter::PythonConsoleError));
    ...
    case MessageOutput:
        {
            ...
            outputFormat.setForeground(colorByType(SyntaxHighlighter::PythonConsoleOutput));
